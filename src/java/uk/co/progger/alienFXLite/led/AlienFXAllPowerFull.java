...
public class AlienFXAllPowerFull extends AlienFXController {
	...
	public static final int REGION_LEFT_KEYBOARD = 0x0004; 
	public static final int REGION_MIDDLE_LEFT_KEYBOARD = 0x0008; 
