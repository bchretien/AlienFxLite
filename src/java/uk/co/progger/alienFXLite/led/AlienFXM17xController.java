...
public class AlienFXM17xController extends AlienFXController {
	...
	private static final int BLOCK_BAT_CRITICAL = 0x07;
	...
	public AlienFXM17xController(String description) {
		...
		regions.add(new AlienFXRegion(AlienFXProperties.POWER_BUTTON_ID, AlienFXTexts.POWER_BUTTON_DESCRIPTION, REGION_POWER_BUTTON,2,false,false,true, powermodes));
	...
	@Override
	public int deviceId() {
		return LEDController.M17XR3_ALIENFX;
	}
}
