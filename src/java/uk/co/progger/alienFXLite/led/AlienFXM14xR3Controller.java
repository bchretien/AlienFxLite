...
public class AlienFXM14xR3Controller extends AlienFXController {
	...
	public static final int REGION_LEFT_KEYBOARD = 0x0001; 
	public static final int REGION_MIDDLE_LEFT_KEYBOARD = 0x0002; 
	public static final int REGION_MIDDLE_RIGHT_KEYBOARD = 0x0004; 
	public static final int REGION_RIGHT_KEYBOARD = 0x0008; 
	public static final int REGION_POWER_BUTTON_2 = 0x0010; 
	public static final int REGION_LEFT_SPEAKER = 0x0020; 
	public static final int REGION_RIGHT_SPEAKER = 0x0040;
	...
	public static final int REGION_POWER_BUTTON = 0x2000; //Doesn't work, needs new address. Power button has changed from previous generation.
	public static final int REGION_POWER_BUTTON_EYES = 0x4000; //Doesn't work.
	
	public AlienFXM14xR3Controller() {
		super("Alienware M14x R3", STATE_BUSY, STATE_READY, STATE_UNKNOWN_COMMAND,
	...
	@Override
	public int deviceId() {
		return LEDController.M14XR3_ALIENFX;
	}
}
